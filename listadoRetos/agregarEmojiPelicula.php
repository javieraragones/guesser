...
<head>
    <meta charset="UTF-8">
    <title>Agregar Reto Emojis Pelicula</title>
    ...
    <script>
        ...
        function agregarEmoji() {
            ...
            fetch('http://localhost:81/peliculaEmojis', {
                ...
                .then(data => {
                    ...
                    resetForm();
                    window.location.href = 'listadoEmojisPeliculas.php';
                })
                .catch(error => {
        ...
        function validarFormulario() {
            var formulario = document.getElementById("formulario-agregar-emoji-pelicula");
...
<body>
    <h1>Agregar Reto Emojis Pelicula</h1>
    <form id="formulario-agregar-emoji-pelicula" class="formulario-agregar-reto" onsubmit="return validarFormulario()">
    ...
    <div id="tabla-previsualizacion-emojis-pelicula" class="tabla-previsualizacion tabla-previsualizacion-emojis">
