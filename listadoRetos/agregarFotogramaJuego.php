...
<head>
    <meta charset="UTF-8">
    <title>Agregar Fotograma de Juego</title>
    ...
    <script>
        ...
        function agregarFotograma() {
            ...
            fetch('http://localhost:81/juegoFotogramas', {
                ...
                .then(data => {
                    ...
                    resetForm();
                    window.location.href = 'listadoFotogramasJuegos.php';
                })
                .catch(error => {
        ...
        function validarFormulario() {
            var formulario = document.getElementById("formulario-agregar-fotograma-juego");
        ...
        async function obtenerRetosGuardados() {
            try {
                const response = await fetch('http://localhost:81/juegoFotogramas');
                if (!response.ok) {
...
<body>
    <h1>Agregar Fotograma de Juego</h1>
    <form id="formulario-agregar-fotograma-juego" class="formulario-agregar-reto" onsubmit="return validarFormulario()">
    ...
    <div id="tabla-previsualizacion-fotogramas-juego" class="tabla-previsualizacion tabla-previsualizacion-fotograma">
        <table id="table-tabla-previsualizacion-fotogramas-juego" class="table-tabla-previsualizacion">
            <thead>
                <tr>
