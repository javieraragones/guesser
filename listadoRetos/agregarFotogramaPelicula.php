...
<head>
    <meta charset="UTF-8">
    <title>Agregar Fotograma de Pelicula</title>
    ...
    <script>
        ...
        function agregarFotograma() {
            ...
            fetch('http://localhost:81/peliculaFotogramas', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    resetForm();
                    window.location.href = 'listadoFotogramasPeliculas.php';
                })
                .catch(error => {
        ...
        function validarFormulario() {
            var formulario = document.getElementById("formulario-agregar-fotograma-pelicula");
...
<body>
    <h1>Agregar Fotograma de Pelicula</h1>
    <form id="formulario-agregar-fotograma-pelicula" class="formulario-agregar-reto" onsubmit="return validarFormulario()">
    ...
    <div id="tabla-previsualizacion-fotogramas-pelicula" class="tabla-previsualizacion tabla-previsualizacion-fotograma">
        <table id="table-tabla-previsualizacion-fotogramas-pelicula" class="table-tabla-previsualizacion">
            <thead>
                <tr>
