...
<head>
    <meta charset="UTF-8">
    <title>Agregar Personaje Serie</title>
    ...
    <script>
        ...
        function agregarPersonaje() {
            ...
            const nombreSerie = document.getElementById('nombre-serie').value;
            ...
            fetch('http://localhost:81/seriePersonaje', {
                    method: 'POST',
                    headers: {
        ...
        function validarFormulario() {
            var formulario = document.getElementById("formulario-agregar-personaje-serie");
...
<body>
    ...
    <form id="formulario-agregar-personaje-serie" class="formulario-agregar-reto" onsubmit="return validarFormulario()">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nombre-serie" required>
        </div>
        <div class="form-group">
    ...
    <div id="tabla-previsualizacion-personaje-serie" class="tabla-previsualizacion tabla-previsualizacion-personaje">
